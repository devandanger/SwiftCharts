...
public class ChartUtils {
     ...
     */
    public class func textSize(_ text: String, font: UIFont) -> CGSize {
        return AttributedString(string: text, attributes: [NSFontAttributeName: font]).size()
    }
     ...
     */
    public class func rotatedTextBounds(_ text: String, font: UIFont, angle: CGFloat) -> CGRect {
     ...
     */
    public class func boundingRectAfterRotatingRect(_ rect: CGRect, radians: CGFloat) -> CGRect {
        let xfrm = CGAffineTransform(rotationAngle: radians)
        return rect.apply(transform: xfrm)
    }
     ...
     */
    public class func toDispatchTime(_ secs: Float) -> DispatchTime {
