...
class ChartAxisXLayerDefault: ChartAxisLayerDefault {
    ...
    private func generateAxisTitleLabelsDrawers(_ labels: [ChartAxisLabel], spacingLabelAxisX: CGFloat, spacingLabelBetweenAxis: CGFloat, offset: CGFloat) -> [ChartLabelDrawer] {
    ...
    private func rowHeightsForRows(_ rows: [[ChartAxisLabel?]]) -> [CGFloat] {
