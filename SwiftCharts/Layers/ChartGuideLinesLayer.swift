...
public class ChartGuideLinesLayerAbstract<T: ChartGuideLinesLayerSettings>: ChartCoordsSpaceLayer {
    ...
    private func drawGuideline(_ context: CGContext, p1: CGPoint, p2: CGPoint) {
        fatalError("override")
    }
...
public class ChartGuideLinesLayer_<N>: ChartGuideLinesLayerAbstract<ChartGuideLinesLayerSettings> {
    ...
    override private func drawGuideline(_ context: CGContext, p1: CGPoint, p2: CGPoint) {
...
public class ChartGuideLinesForValuesLayerAbstract<T: ChartGuideLinesLayerSettings>: ChartCoordsSpaceLayer {
    ...
    private func drawGuideline(_ context: CGContext, color: UIColor, width: CGFloat, p1: CGPoint, p2: CGPoint, dotWidth: CGFloat, dotSpacing: CGFloat) {
